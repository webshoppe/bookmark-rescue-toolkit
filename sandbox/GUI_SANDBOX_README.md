...
2. Double-click `Launch_GUI_Sandbox.bat`  
...
> **Security warning on first run:** Windows may show an "Unknown Publisher"
> warning when double-clicking the launcher. This happens because Windows tags
> files downloaded or extracted from a zip with a security zone marker.
> To fix it permanently: right-click `Launch_GUI_Sandbox.bat` > Properties >
> tick **Unblock** at the bottom > OK. The warning will not appear again.
